...
public class TimelineTest {
    ...
    FakeItem FAKE_ITEM_ONE=new FakeItem();
    FakeItem FAKE_ITEM_TWO=new FakeItem();
    FakeItem FAKE_ITEM_THREE=new FakeItem();
    FakeItem FAKE_ITEM_FOUR=new FakeItem();
    FakeItem FAKE_ITEM_FIVE=new FakeItem();
    FakeItem FAKE_ITEM_SIX=new FakeItem();
    FakeItem FAKE_ITEM_SEVEN=new FakeItem();
...
/*
    ...
    Exercise 1:
    Test Scenario-
    Timeline should be able to get list of items.
